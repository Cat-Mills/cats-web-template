...
const ItemPage = () => {
    ...
    return (
        <div className="pt-[12vh] h-screen flex flex-col items-center">
            {/* Success Popup */}
            <div
                className={
                    isAdded
                        ? "h-[5vh] fixed  bg-emerald-700 w-full flex justify-center items-center transition-opacity duration-300 animate-fade-alert animate-duration-[6000ms]"
